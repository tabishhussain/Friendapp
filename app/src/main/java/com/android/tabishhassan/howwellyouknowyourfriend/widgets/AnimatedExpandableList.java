package com.android.tabishhassan.howwellyouknowyourfriend.widgets;

/**
 * Created by tabishhassan on 7/22/15.
 */
 ...
 */
public class AnimatedExpandableList extends ExpandableListView {
    /*
    ...
    public AnimatedExpandableList(Context context) {
        super(context);
    }

    public AnimatedExpandableList(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public AnimatedExpandableList(Context context, AttributeSet attrs, int defStyle) {
    ...
    public static abstract class AnimatedExpandableListAdapter extends BaseExpandableListAdapter {
        ...
        private AnimatedExpandableList parent;

        private static final int STATE_IDLE = 0;
        private static final int STATE_EXPANDING = 1;
        private static final int STATE_COLLAPSING = 2;

        private void setParent(AnimatedExpandableList parent) {
            this.parent = parent;
        }
